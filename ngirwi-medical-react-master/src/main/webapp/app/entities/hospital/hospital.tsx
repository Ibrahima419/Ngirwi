    ...
    >
      ...
      <div className="table-responsive">
        {hospitalList && hospitalList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('adress')}>
                  Adress <FontAwesomeIcon icon="sort" />
                </th>
              ...
              {hospitalList.map((hospital, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {hospital.logo ? (
                      <div>
                        {hospital.logoContentType ? (
                          <a onClick={openFile(hospital.logoContentType, hospital.logo)}>
                            <img src={`data:${hospital.logoContentType};base64,${hospital.logo}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {hospital.logoContentType}, {byteSize(hospital.logo)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && <div className="alert alert-warning">Aucun Hospital trouvé</div>
        )}
      </div>
      {totalItems ? (
